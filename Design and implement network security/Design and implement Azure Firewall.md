...
![Diagram of Azure firewall configuration](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-network-security-monitoring/media/firewall-standard.png)
