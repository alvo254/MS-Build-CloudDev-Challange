...
![Diagram illustrating always-on traffic monitoring with DDoS protection.](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-network-security-monitoring/media/always-on-traffic-monitoring-d9296111.png)
...
![Diagram illustrating adaptive real-time tuning in DDoS protection.](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-network-security-monitoring/media/adaptive-real-time-tuning-c2c94bd4.png)
...
![Chart displaying mitigation policy metrics from DDoS Protection Standard](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-network-security-monitoring/media/ddos-mitigation-policies-586c35e7.png)
...
![Chart displaying metric for 'Under DDoS attack or not'](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-network-security-monitoring/media/under-ddos-attack-metric-a946df9a.png)
...
![Diagram illustrating the Web Application Firewall Application Gateway](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-network-security-monitoring/media/waf-application-gateway-a8c1eff1.png)
