...
![Connect from a computer to an Azure VNet - point-to-site connection diagram](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-hybrid-networking/media/point-site-diagram.png)
...
![RADIUS authentication of client.](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-hybrid-networking/media/p2s-authenticate-with-ad-b603595a.png)
...
![configuration window in the Azure portal for a point to site connection](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-hybrid-networking/media/configure-point-site-45b81c3f.png)
