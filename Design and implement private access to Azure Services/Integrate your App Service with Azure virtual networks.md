...
[![Select VNet Integration](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-private-access-to-azure-services/media/vnet-integration-416e7c79.png)](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-private-access-to-azure-services/media/vnet-integration-416e7c79.png#lightbox)
...
[![Select the VNet](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-private-access-to-azure-services/media/vnet-integration-configuration-15c78756.png)](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-private-access-to-azure-services/media/vnet-integration-configuration-15c78756.png#lightbox)
...
![Select Classic VNet](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-private-access-to-azure-services/media/vnet-details-e19017ad.png)
...
![Provide application setting](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-private-access-to-azure-services/media/vnet-integration-app-setting-6e6a7148.png)
...
If you want to make calls to [Private Endpoints](https://learn.microsoft.com/en-us/azure/app-service/networking/private-endpoint), then you must make sure that your DNS lookups resolve to the Private Endpoint. You can enforce this behavior in one of the following ways:
...
![diagram shows how the AKS nodes receive an IP address in the virtual network subnet, but not the pods](https://learn.microsoft.com/en-us/training/wwl-azure/design-implement-private-access-to-azure-services/media/kunenet-overview-2c08edda.png)
...
- Features **not supported on kubenet** include:
    ...
    - [Azure network policies](https://learn.microsoft.com/en-us/azure/aks/use-network-policies), but Calico network policies are supported on kubenet
    - [Windows node pools](https://learn.microsoft.com/en-us/azure/aks/windows-faq)
    - [Virtual nodes add-on](https://learn.microsoft.com/en-us/azure/aks/virtual-nodes)
